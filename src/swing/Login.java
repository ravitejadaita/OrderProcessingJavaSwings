...
public class Login extends javax.swing.JFrame {
    ...
    public Login() {
        ...
        if(c.vcount==1){
        Login.InfoBox("HOVER ON THE FIELDS TO EASILY IDENTIFY INPUT TYPE", " USEFUL TIP !!!  ");
        c.adddata("sushant","admin","1234567890");
        c.addS("sushant","admin");
        c.adddata("ravi","admin","1234567891");
        c.addS("ravi","admin");
        c.adddata("ananya","admin","1234567892");
        c.addS("ananya","admin");
        c.adddatagender("sushant", "Male");
        c.adddatagender("ravi", "Male");
        c.adddatagender("ananya", "Female");
        c.vcount--;
        }
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 50, 170, 530));
        ...
        btn_exit2.setBackground(new java.awt.Color(71, 120, 197));
        btn_exit2.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btn_exit2.setForeground(new java.awt.Color(71, 120, 197));
        btn_exit2.setText("SignUp");
        ...
        jLabel16.setText("Have you not registered yet ?");
        ...
        btn_9Layout.setVerticalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, btn_9Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addGroup(btn_9Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_exit2)
                    .addComponent(jLabel16))
                .addContainerGap())
        );
        ...
        jLabel6.setText("Welcome to SuRaAn Apparel Ordering System !");
        ...
        btn_exit4.setBackground(new java.awt.Color(204, 204, 255));
        btn_exit4.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btn_exit4.setForeground(new java.awt.Color(204, 204, 255));
        btn_exit4.setText("FORGOT PASSWORD ?");
        ...
        btn_11Layout.setHorizontalGroup(
            ...
            .addGroup(btn_11Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(btn_exit4, javax.swing.GroupLayout.PREFERRED_SIZE, 205, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(113, 113, 113))
        );
        ...
        btn_10.setForeground(new java.awt.Color(204, 204, 255));
        ...
        btn_exit3.setBackground(new java.awt.Color(204, 204, 255));
        btn_exit3.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        btn_exit3.setForeground(new java.awt.Color(204, 204, 255));
        btn_exit3.setText("AUTOFILL PASSWORD");
        ...
        username.setToolTipText("Enter Existing Account Username only ,else Please SignUp");
        username.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 102), 2, true));
        username.setOpaque(false);
        username.setSelectionColor(new java.awt.Color(0, 0, 102));
        ...
        jPasswordField1.setToolTipText("Enter Existing Accounts Valid Password");
        jPasswordField1.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 102), 2, true));
        jPasswordField1.setSelectionColor(new java.awt.Color(0, 0, 102));
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel4Layout.createSequentialGroup()
                                .addGap(25, 25, 25)
                                .addComponent(btn_11, javax.swing.GroupLayout.PREFERRED_SIZE, 216, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(60, 60, 60)
        ...
        getContentPane().add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 70, 750, 390));
    ...
    private void btn_exit3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_exit3MouseClicked
        // TODO add your handling code here:
        CheckPass c =new CheckPass();
        String pass = c.getdataS(username.getText());
        try{
        if(pass.isEmpty()){
            jLabel20.setText("PLEASE MAKE AN ACCOUNT FIRST");
        }
        else{
    ...
    private void btn_exit5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_exit5MouseClicked
        // TODO add your handling code here:
        if(username.getText().isEmpty() && jPasswordField1.getText().isEmpty()) {
            jLabel20.setText("USERNAME AND PASSWORD CANNOT BE EMPTY");
        ...
        CheckPass c =new CheckPass ();
        if(c.Checkn(username.getText(),jPasswordField1.getText())){
            account=username.getText();
             jLabel20.setText("STATUS :- VALID ACCOUNT");
            //this.setVisible(false);
            //**************change this login to next page
            ...
            jLabel20.setText("STATUS :- INVALID ACCOUNT");
            //c.See();
        }
        }
    ...
    private void btn_2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btn_2MouseClicked
        ...
        if(c.Checkusername(username.getText())){
                ...
                this.setVisible(false);
                jLabel20.setVisible(true);
                new MyProfile(username.getText()).setVisible(true);
