 ...
 * @author Admin
 */
public class payment_cod extends javax.swing.JFrame {
    ...
    public payment_cod() {
        ...
        resetColor(new JPanel[]{btn_3,btn_4}, new JPanel[]{ind_3,ind_1});
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        if(!(jTextField2.getText().replaceAll("[1234567890]", "")).isEmpty() || !(jTextField2.getText().length() == 10) || jTextField2.getText().isEmpty())
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(payment_cod.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new payment_cod().setVisible(true);
            }
        });
    }
